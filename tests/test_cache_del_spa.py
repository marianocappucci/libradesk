...
def cliente(tmp_path_factory):
    ...
    if creado:
        (dist / "index.html").write_text(
            "<!doctype html><title>LibraDesk</title>", encoding="utf-8"
        )
    ...
    previo = {v: os.environ.get(v) for v in
              ("ENV", "LIBRADESK_ADMIN_USERNAME", "LIBRADESK_ADMIN_PASSWORD",
               "SECRET_KEY", "DATA_DIR")}
    os.environ["ENV"] = "development"
    os.environ["LIBRADESK_ADMIN_USERNAME"] = "admin"
    os.environ["LIBRADESK_ADMIN_PASSWORD"] = "clave-de-prueba"
