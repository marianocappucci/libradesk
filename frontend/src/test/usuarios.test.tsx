// Adopción del router de usuarios de libraauth (ADR-018, v0.43.1/v0.71.0):
// el backend ya trae `DELETE /api/usuarios/{id}` con las guardas del único
// admin y de uno mismo, así que el shim de este producto
// (`pages/Usuarios.tsx`) pasa `permitirEliminar` y `usuarioActualId` a la
// pantalla compartida.
//
...
beforeEach(() => {
  vi.stubGlobal('fetch', vi.fn((url: string) => {
    const cuerpo = String(url).includes('/api/usuarios') ? USUARIOS : []
